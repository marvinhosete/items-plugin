...
public class ToolsAttributesView extends View {

    private final Configuration itemsConfiguration;

    public ToolsAttributesView(Configuration itemsConfiguration) {
        super(3, "Atributos de Ferramentas");
    ...
    protected void onRender(ViewContext context) {
        ...
        ItemAttribute[] toolsAttributes = ItemAttribute.getToolsAttributes();
        for (int i = 0; i < toolsAttributes.length; i++) {
            ItemAttribute attribute = toolsAttributes[i];
